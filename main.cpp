...
protected:
	...
	int numMallas = 6;
	std::string refObject[6] =
	{
		"humano","Jaguar","isla","humano1",
		"Bote","fogata"
	};
   GLMmodel* objmodel_ptr[6];
...
public:
	...
	void moverMalla() { //Objeto interactivo
		if (xIzquierda) {
			posX -= 0.05;
		}
		if (xDerecha) {
	...
	virtual void OnRender(void)
	{
      ...
      if (shader) shader->begin();
		 ...
		 glRotatef(150, 0, 1, 0);
		  ...
		  glPushMatrix();
		  glTranslatef(0, 0, -5);
		  glRotatef(timer010 * 90, 0.5, 1.0f, 0.1f);
		  glScalef(1, 1, 1);
		  ...
		  glTranslatef(0, 0, -4);
		  glmDraw(objmodel_ptr[5], GLM_SMOOTH | GLM_MATERIAL);
		  glPopMatrix();
